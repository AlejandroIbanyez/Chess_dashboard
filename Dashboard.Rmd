...
### Best Win
```{r Best_win_bullet}
valueBox(Best_Win_bullet, icon = "ion-trophy")
```

### Average ELO opponent
```{r Mean_bullet}
valueBox(Mean_ELO_Bullet, icon="fa-user")
```
...
### Best Win
```{r Best_win_blitz}
valueBox(Best_Win_blitz, icon = "ion-trophy")
```

### Average ELO opponent
```{r Mean_blitz}
valueBox(Mean_ELO_blitz, icon="fa-user")
```
...
### Best Win
```{r Best_win_rapid}
valueBox(Best_Win_rapid, icon = "ion-trophy")
```

### Average ELO opponent
```{r Mean_rapid}
valueBox(Mean_ELO_rapid, icon="fa-user")
```
